  ...
  return (
    ...
    >
      <Container maxWidth="xl" disableGutters sx={{ maxWidth: '1200px', mx: 'auto' }}>
        <Grid container spacing={{ xs: 2, md: 3 }} column={{ xs: 16, sm: 12, md: 6 }}>
          {/* Left: About Text */}
          <Grid size={{ xs:16, sm:12, md:6 }} >
          ...
          <Grid size={{ xs:16, sm:12, md:6 }} sx={{ mt: 7 }}>
            <Grid container spacing={{ xs: 6, sm:3, md: 2 }}>
              ...
              <Grid size={{ xs:16, sm:12, md:6 }} key="ml">
                <Item>
              ...
              <Grid size={{ xs:16, sm:12, md:6 }} key="cloud">
                <Item>
              ...
              <Grid size={{ xs:16, sm:12, md:6 }} key="leadership">
                <Item>
